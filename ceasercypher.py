...
def analyze_message(message):
    ...
    print(f"First and last characters of the message: {message[:1]}***{message[-1]}")
...
def main():
    ...
    # Use getpass to make the message input invisible
    message = getpass.getpass(prompt="Enter the message (invisible, type carefully): ")

    analyze_message(message)

    # Use getpass to make the shift value input invisible
